...
{
    public partial class StartupAppsWindow2 : Window
    {
        public StartupAppsWindow2()
        {
            InitializeComponent();
        }

        private void OpenHeerbeeck_Click(object sender, RoutedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://heerbeeck.nl",
